      ...
      >
        ...
        <header className="fixed w-full top-0 z-50 bg-dark/80 backdrop-blur-md border-b border-white/10">
          <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
            <h1 className="text-xl font-bold ">Ayush Raghuvanshi</h1>
            <nav className="hidden md:block">
              <ul className="flex space-x-8">
                ...
                <li>
                  <a 
                    href="https://drive.google.com/drive/folders/1_MN3dQClQ5HYUNIYwfWijS1IMjDorRuN?dmr=1&ec=wgc-drive-globalnav-goto" 
        ...
        <footer className="py-12 px-4 border-t border-white/10 relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            <p className="text-white/60">
              © {new Date().getFullYear()} Ayush Raghuvanshi. All rights reserved.
            </p>
          </div>
        </footer>
      </motion.div>
